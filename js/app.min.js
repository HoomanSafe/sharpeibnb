...
(() => { // webpackBootstrap
    ...
    var __webpack_modules__ = ([
        ...
        ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
            ...
            const __WEBPACK_DEFAULT_EXPORT__ = (scrollAnimation);
        ...
        ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
            ...
            /* harmony default export */
            const __WEBPACK_DEFAULT_EXPORT__ = (appHeight);
    ...
    (() => {
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */
        var _modules_animations_scrollAnimation_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
        /* harmony import */
        var _modules_functions_appHeight_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);



        (0, _modules_functions_appHeight_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
        (0, _modules_animations_scrollAnimation_js__WEBPACK_IMPORTED_MODULE_0__["default"])();

        const scrollToSection = (link, e) => {
            e.preventDefault();
            const target = link.getAttribute('href').replace('#', '');
            const section = document.querySelector(`.${target}`);
            const scrollValue = section.getBoundingClientRect().top + scrollY - document.querySelector(".header").offsetHeight;
        ...
        document.getElementById('tv_container').addEventListener('click', togglePlayPause);
